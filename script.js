...
document.getElementById('login-form').addEventListener('submit', async function (e) {
  ...
  if (username === 'ambulatorio' && password === 'ambulatorio') {
    const powerBIUrl = "https://app.powerbi.com/view?r=eyJrIjoiMTFlMDNhZWYtMTM0Ni00MGI2LTlhMzYtYTEyN2ZlN2Q1ZjY2IiwidCI6IjNhNzhiMGNkLTdjOGUtNDkyOS08M2Q1LTE5MGE2Y2MwMTM2NSJ9";
    ...
    try {
      const response = await fetch("https://script.google.com/macros/s/AKfycbwVOSZnHUeKfRUyxy66QGegekodo8H4Hsf1efk2awz2w7ZCCjTmT8hSww2HEJ4cJOMZ6Q/exec", {
        ...
        body: new URLSearchParams({ setor: "Estomaterapia" })
      });
